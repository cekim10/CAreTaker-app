...
export default function Features() {
  return (
    <ScrollView style={{height: hp(60)}} bounces={false} showsVerticalScrollIndicator={false} className="space-y-4">
        <Text style={{fontSize: wp(6.5)}} className="font-semibold text-white-700">Features</Text>
        <View className="bg-orange-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                ...
                <Text style={{fontSize: wp(4.8)}} className="font-semibold text-gray-700">Personalized Chat</Text>
            </View>
        ...
        <View className="bg-purple-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                <Image className="rounded-ful" source={require('../../assets/images/aiIcon.png')} style={{height: hp(4), width: hp(4)}} />
                <Text style={{fontSize: wp(4.8)}} className="font-semibold text-gray-700">Daily Tasks</Text>
            </View>
        ...
        <View className="bg-red-200 p-4 rounded-xl space-y-2">
            <View className="flex-row items-center space-x-1">
                <Image className="rounded-ful" source={require('../../assets/images/aiIcon.png')} style={{height: hp(4), width: hp(4)}} />
                <Text style={{fontSize: wp(4.8)}} className="font-semibold text-gray-700">Emergency Support</Text>
            </View>
